    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (localStringTracker) {
            if (localString != null) {
                ...
                // write null attribute
                writeStartElement(null, "http://developer.intuit.com/", "string", xmlWriter);
        ...
        if (localStringTracker) {
            if (localString != null) {
                for (int i = 0; i < localString.length; i++) {
                    ...
                    if (localString[i] != null) {
                        elementList.add(new javax.xml.namespace.QName("http://developer.intuit.com/", "string"));
                        elementList
                                .add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localString[i]));
                    } else {
    ...
    public static class Factory {
        ...
        public static ArrayOfString parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
            ...
            try {
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://developer.intuit.com/", "string")
                    ...
                    while (!loopDone1) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName("http://developer.intuit.com/", "string")
                                    .equals(reader.getName())) {
