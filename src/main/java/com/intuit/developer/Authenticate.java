...
public class Authenticate implements org.apache.axis2.databinding.ADBBean {
    ...
    public String toString() {
        return "Authenticate{" +
                "localStrUserName='" + localStrUserName + '\'' +
                ", localStrUserNameTracker=" + localStrUserNameTracker +
                ", localStrPassword='" + localStrPassword + '\'' +
                ", localStrPasswordTracker=" + localStrPasswordTracker +
                '}';
    }

    public static final javax.xml.namespace.QName MY_QNAME =
            new javax.xml.namespace.QName("http://developer.intuit.com/", "authenticate", "ns1");
    ...
    protected String localStrUserName;
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    protected String localStrPassword;
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                ...
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "authenticate", xmlWriter);
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localStrUserNameTracker) {
            elementList.add(new javax.xml.namespace.QName("http://developer.intuit.com/", "strUserName"));
        ...
        if (localStrPasswordTracker) {
            elementList.add(new javax.xml.namespace.QName("http://developer.intuit.com/", "strPassword"));
    ...
    public static class Factory {
         ...
         */
        public static Authenticate parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
            ...
            try {
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                                "The element: " + "strUserName" + "  cannot be null");
                    }


                    String content = reader.getElementText();

                    object.setStrUserName(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                                "The element: " + "strPassword" + "  cannot be null");
                    }


                    String content = reader.getElementText();

                    object.setStrPassword(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
